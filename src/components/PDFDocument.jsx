...
const styles = StyleSheet.create({
  page: {
    backgroundColor: `${Colors.grey.c0}`,
  ...
  header: {
    padding: "20px 40px",
    backgroundColor: `${Colors.grey.c10}`, // e.g. you reuse this color a lot. Should be in a constants file. I've created a simple example file
    display: "flex",
    flexDirection: "row",
        ...
        <Page key={index} wrap size="A4" style={styles.page}>
          <View style={styles.container}>
            ...
            <View style={styles.header}>
              <Image src={companyDetails.companyLogo} style={styles.image} />
            ...
            {index === 0 && (
              <View style={styles.invoiceDetails}>
                <View>
                  <Text style={styles.invoiceDetailsTextH1}>From</Text>
                ...
                <View>
                  <Text style={styles.invoiceDetailsTextH1}>Billed To</Text>
                  <Text>{formEntryDetails.customer}</Text>
                  {formEntryDetails.customer && (
                    <View>
                      <Text>
                        {customerDetails[formEntryDetails.customer]?.address}
                      </Text>
                      <Text>
                ...
                <View style={styles.invoiceDates}>
                  <View style={styles.invoiceDateWrapper}>
                    <Text style={styles.invoiceDetailsTextH1}>Issued</Text>
                    <Text>{formEntryDetails.issueDate}</Text>
                  </View>
                  <View style={styles.invoiceDateWrapper}>
                    <Text style={styles.invoiceDetailsTextH1}>Due</Text>
              ...
              <View wrap key={lineItem.id} style={styles.lineItem}>
                ...
                <View wrap style={styles.lineItemContainer}>
                  ...
                  <View style={styles.lineItemRightSection}>
                    <Text style={styles.lineItemRightSectionText}>
                      {lineItem.qty}
                    </Text>
                    <Text style={styles.lineItemRightSectionText}>
                      $ {lineItem.price}
